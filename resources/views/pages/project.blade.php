            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <ul class="nav nav-pills nav-justified border border-1 border-radius-18 border-color-primary-1">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link height-75 d-flex justify-content-center align-items-center color-primary-2 text-font-jost text-weight-600 text-size-18 tab_hover border-radius-18" href="/404">Living Area</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-2"></div>
        ...
        <div class="container mt-5">
            <div class="row grid-container">
                <div class="col-md-6 mt-5">
                    <div class="clikable" onclick="location.href = '/project_details'">
