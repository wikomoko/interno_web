...
@section('content')
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="quote_pad text-center">
    ...
    <section class="bg-color-primary-3">
        <div class="container text-center padding_vertical_180 margin_top_150">
            <p class="text-font-dm text-size-50 color-primary-2">What the People Thinks <br />About Us</p>
            <div class="row">
    ...
    <section>
        <div class="container padding_vertical_180">
            <p class="text-font-dm text-size-50 color-primary-2 text-center">Creative project? Let's have
